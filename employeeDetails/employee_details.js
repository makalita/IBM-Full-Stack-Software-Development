...
function findJSSpecialization() {
    const jsSpecializedEmployee = employees.find(employee => employee.specialization === 'JavaScript');
    if (jsSpecializedEmployee) {
        document.getElementById('employeesDetails').innerHTML = `<p>${jsSpecializedEmployee.id}: ${jsSpecializedEmployee.name}: ${jsSpecializedEmployee.name} - ${jsSpecializedEmployee.department} - $${jsSpecializedEmployee.salary} - ${jsSpecializedEmployee.specialization}</p>`;
    }
    else {
        document.getElementById('employeesDetails').innerHTML = 'no employee has been found with a JavaScript specialization';
    }
}